...
func VRF_verify(source int,pk VRFPublicKey, pi VRFProve, m []byte, h uint64, preBH *types.BlockHeader) (bool, error) {
	return ed25519.ECVRF_verify(source,ed25519.PublicKey(pk), ed25519.VRFProve(pi), m, h, preBH)
}
