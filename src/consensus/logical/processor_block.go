...
func (p *Processor) doAddOnChain(block *core.Block) (result int8) {
	begin := time.Now()
	defer func() {
...
func (p *Processor) blockOnChain(bh *core.BlockHeader) bool {
...
func (p *Processor) getBlockHeaderByHash(hash common.Hash) *core.BlockHeader {
...
func (p *Processor) blockPreview(bh *core.BlockHeader) string {
