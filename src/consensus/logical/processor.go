...
//检查铸块组是否合法
func (p *Processor) isCastLegal(source int, bh *types.BlockHeader, preHeader *types.BlockHeader) (ok bool, group *StaticGroupInfo, err error) {
	...
	if ok2, err2 := vrfVerifyBlock(source, bh, preHeader, minerDO, totalStake); !ok2 {
