...
func (p *Processor) genCastGroupSummary(bh *core.BlockHeader) *CastGroupSummary {
	var gid groupsig.ID
...
func (p *Processor) receiveBlock(msg *ConsensusBlockMessage, preBH *core.BlockHeader) bool {
