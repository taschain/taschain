...
//}
//
//func (bc *BlockContext) replaceVerifyCtx(height uint64, expireTime time.TimeStamp, preBH *types.BlockHeader) *VerifyContext {
//	vctx := newVerifyContext(bc, height, expireTime, preBH)
//	bc.vctxs[vctx.castHeight] = vctx
//	return vctx
//}
//
//func (bc *BlockContext) getOrNewVctx(height uint64, expireTime time.TimeStamp, preBH *types.BlockHeader) *VerifyContext {
