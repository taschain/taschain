...
func New(root common.Hash, db Database) (*AccountDB, error) {
...
func (self *AccountDB) AddLog(log *types.Log) {
...
func (self *AccountDB) GetLogs(hash common.Hash) []*types.Log {
	return self.logs[hash]
}

func (self *AccountDB) Logs() []*types.Log {
	var logs []*types.Log
...
// deleteAccountObject removes the given object from the state trie.
...
func (self *AccountDB) getAccountObject(addr common.Address) (stateObject *accountObject) {
	...
	obj := newObject(self, addr, data, self.MarkAccountObjectDirty)
...
// MarkAccountObjectDirty adds the specified object to the dirty map to avoid costly
...
func (self *AccountDB) createObject(addr common.Address) (newobj, prev *accountObject) {
	...
	newobj = newObject(self, addr, Account{}, self.MarkAccountObjectDirty)
...
func (self *AccountDB) RevertToSnapshot(revid int) {
	...
	// Replay the transition to undo changes.
...
// and clears the transition as well as the refunds.
func (s *AccountDB) Finalise(deleteEmptyObjects bool) {
	...
	// Invalidate transition because reverting across transactions is not allowed.
