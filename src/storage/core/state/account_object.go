...
func (self *accountObject) GetState(db Database, key string) []byte {
...
func (self *accountObject) SetState(db Database, key string, value []byte) {
...
func (self *accountObject) setState(key string, value []byte) {
	self.cachedStorage[key] = value
