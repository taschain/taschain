...
func (self *AccountDB) GetState(a common.Address, b string) []byte {
...
func (self *AccountDB) SetState(addr common.Address, key string , value []byte) {
	stateObject := self.GetOrNewStateObject(addr)
	if stateObject != nil {
...
func (self *AccountDB) updateStateObject(stateObject *accountObject) {
...
func (self *AccountDB) deleteStateObject(stateObject *accountObject) {
...
func (self *AccountDB) getStateObject(addr common.Address) (stateObject *accountObject) {
	// Prefer 'live' objects.
...
func (self *AccountDB) setStateObject(object *accountObject) {
	self.accountObjects[object.Address()] = object
}

// Retrieve a state object or create a new state object if nil
func (self *AccountDB) GetOrNewStateObject(addr common.Address) *accountObject {
	stateObject := self.getStateObject(addr)
...
func (self *AccountDB) MarkStateObjectDirty(addr common.Address) {
...
func (self *AccountDB) Copy() *AccountDB {
	...
	for addr := range self.accountObjectsDirty {
		state.accountObjects[addr] = self.accountObjects[addr].deepCopy(state, state.MarkStateObjectDirty)
...
func (s *AccountDB) Finalise(deleteEmptyObjects bool) {
	for addr := range s.accountObjectsDirty {
		stateObject := s.accountObjects[addr]
...
func (s *AccountDB) Commit(deleteEmptyObjects bool) (root common.Hash, err error) {
	...
	for addr, stateObject := range s.accountObjects {
