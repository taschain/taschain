...
func initServer(config *common.ConfManager, node p2p.Node, isSuper bool) error {
	...
	//if p2p.ConvertToID(id) != p2p.Server.SelfNetInfo.ID.String() {
	//	for {
	...
	if err == nil {
		...
		bnNode := p2p.NewNode(p2p.MustB58ID(seedId), net.ParseIP(seedIp), seedPort)
		if bnNode.ID.String() != node.ID.String() {
	...
	//groupMembers := []p2p.NodeID{p2p.MustHexID("30b7ab30a01c124a6cceca36863ece12c4f5fa68e3ba9b0b51407ccc002eeed3b3102d20a88f1c1d3c3154e2449317b8ef95090e77b312d5cc39354f86d5d606"), p2p.MustHexID("30b7ab30a01c124a6cceca36863ece12c4f5fa68e3ba9b0b51407ccc002eeed3b3102d20a88f1c1d3c3154e2449317b8ef95090e77b312d5cc39354f86d5d607"), p2p.MustHexID("30b7ab30a01c124a6cceca36863ece12c4f5fa68e3ba9b0b51407ccc002eeed3b3102d20a88f1c1d3c3154e2449317b8ef95090e77b312d5cc39354f86d5d608"), p2p.MustHexID("30b7ab30a01c124a6cceca36863ece12c4f5fa68e3ba9b0b51407ccc002eeed3b3102d20a88f1c1d3c3154e2449317b8ef95090e77b312d5cc39354f86d5d609")}
...
//
//	ID := p2p.ConvertToPeerID(localId.String())
