...
type MsgPing struct {
	...
	ProtocolVersion uint32       `protobuf:"varint,7,opt,name=ProtocolVersion,proto3" json:"ProtocolVersion,omitempty"`
}
...
func (m *MsgPing) GetProtocolVersion() uint32 {
	if m != nil {
...
type MsgData struct {
	...
	MessageCode  int32    `protobuf:"varint,10,opt,name=MessageCode,proto3" json:"MessageCode,omitempty"`
}
...
func (m *MsgData) GetMessageCode() int32 {
	if m != nil {
...
func (m *MsgPing) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ProtocolVersion != 0 {
		dAtA[i] = 0x38
		i++
		i = encodeVarintP2P(dAtA, i, uint64(m.ProtocolVersion))
	}
	return i, nil
}
...
func (m *MsgPing) Size() (n int) {
	...
	if m.ProtocolVersion != 0 {
		n += 1 + sovP2P(uint64(m.ProtocolVersion))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 10:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MessageCode |= (int32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorP2P = []byte{
	...
	,
}
