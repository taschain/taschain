...
//	txpool.Add(genContractTx(1, 20000000, "1", "", 1, 0, []byte(code), nil, 0))
...
//	txpool.Add(genContractTx(1, 20000000, "1", contractAddr.GetHexString(), 3, 0, []byte(`{"FuncName": "Test", "Args": [10.123, "ten", [1, 2], {"key":"value", "key2":"value2"}]}`), nil, 0))
