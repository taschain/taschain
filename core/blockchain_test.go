...
//`
	// 交易1
	txpool.AddTransaction(genTestTx("jdai1", 12345, "100", "2", 0, 1))
	...
	//交易2
	txpool.AddTransaction(genTestTx("jdai2", 123456, "2", "3", 0, 1))

	//交易3 执行失败的交易
	txpool.AddTransaction(genTestTx("jdaiddd", 123456, "2", "3", 0, 1))
	...
	//交易3
	txpool.AddTransaction(genTestTx("jdai3", 1, "1", "2", 2, 10))
...
func TestBlockChain_StateTree(t *testing.T) {
	...
	// 交易1
	txpool.AddTransaction(genTestTx("jdai1", 12345, "1", "2", 0, 1))

	//交易2
	txpool.AddTransaction(genTestTx("jdai2", 123456, "2", "3", 0, 2))

	// 交易3 失败的交易
	txpool.AddTransaction(genTestTx("jdai3", 123457, "1", "2", 0, 3))
